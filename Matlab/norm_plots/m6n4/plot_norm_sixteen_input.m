...
p13 = plot((xaxis13 - offset13)/3600, testplotmn13*10^9, 'color', blue_midnight, 'LineWidth',2)

[T,Y] = ode45(@toehold_norm_13,[0 86400],[start_conc13*(max13b-baseline13)/(max13-baseline13), 0, 0],options);
p13b = plot(T/3600,Y(:,3)*10^9, ':', 'color', blue_midnight, 'LineWidth',2)
...
[T,Y] = ode45(@toehold_norm_14,[0 86400],[start_conc14*(max14b-baseline14)/(max14-baseline14), 0, 0],options);
...
[T,Y] = ode45(@toehold_norm_15,[0 86400],[start_conc15*(max15b-baseline15)/(max15-baseline15), 0, 0],options);
...
[T,Y] = ode45(@toehold_norm_16,[0 86400],[start_conc16*(max16b-baseline16)/(max16-baseline16), 0, 0],options);
p16b = plot(T/3600, Y(:,3)*10^9, ':', 'color', green_seafoam, 'LineWidth',2)
%***********************************************************************



%legend([p1 p2 p3 p4 p5 p6 p7 p8],'C = 2.5 nM, R = 2.5 nM', 'C = 2.5 nM, R = 2.5 nM', 'C = 1 nM, R = 0.5 nM','C = 2.5 nM, R = 0.5 nM', 'C = 2.5 nM, R = 0.5 nM', 'C = 1 nM, R = 0.5 nM','C = 2 nM, R = 0.5 nM','C = 5 nM, R = 0.5 nM')

legend([p9 p10 p11 p12 p13 p14 p15 p16],'C = 10 nM, R = 0.5 nM', 'C = 1 nM, R = 0.5 nM', 'C = 2.5 nM, R = 0.5 nM', 'C = 5 nM, R = 0.5 nM','C = 1 nM, R = 0.5 nM****', 'C = 0.5 nM, R = 1 nM****', 'C = 2.5 nM, R = 0.5 nM****', 'C = 0.5 nM, R = 2.5 nM****', 'Location', 'Best')

%LEGEND BOXOFF
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m6n4 plot', 'FontSize', 16);
