function dy = fmin_toehold_norm_14(t,y)

dy = zeros(4,1);

k2 = 0.0015; %calculated from m16 data ALWAYS THE SAME

%k1 = y(4); 
concentration_difference = 0.5*10^(-9); %difference in concentration between reactants
