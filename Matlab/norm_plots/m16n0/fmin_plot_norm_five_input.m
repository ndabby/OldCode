...
[estimated_k] = fminunc(@err_func_m16n0v1, k0);
...
[estimated_k] = fminunc(@err_func_m16n0v2, k0);
...
[estimated_k] = fminunc(@err_func_m16n0v3, k0);
...
[estimated_k] = fminunc(@err_func_m16n0v4, k0);
...
[estimated_k] = fminunc(@err_func_m16n0v5, k0);
...
title('m16n0 mean squared error fit for k2', 'FontSize', 16);
