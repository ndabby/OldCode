...
[estimated_k] = fminunc(@err_func_m16n2v1, k0);
...
[estimated_k] = fminunc(@err_func_m16n2v2, k0);
...
[estimated_k] = fminunc(@err_func_m16n2v3, k0);
...
[estimated_k] = fminunc(@err_func_m16n2v4, k0);
...
[estimated_k] = fminunc(@err_func_m16n2v5, k0);
...
title('m16n2 mean squared error fit for k2', 'FontSize', 16);
