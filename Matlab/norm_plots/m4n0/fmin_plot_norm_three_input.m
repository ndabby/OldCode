...
[estimated_k] = fminunc(@err_func_m4n0v1, k0);
...
[estimated_k] = fminunc(@err_func_m4n0v2, k0);
...
[estimated_k] = fminunc(@err_func_m4n0v3, k0);
...
legend([p1 p2 p3 p3c],'C = 2 uM, R = 50 nM', 'C = 2 uM, R = 50 nM', 'C = 2 uM, R = 100 nM', 'average fit', 'Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m4n0 plot mean squared error fit for k1', 'FontSize', 16);