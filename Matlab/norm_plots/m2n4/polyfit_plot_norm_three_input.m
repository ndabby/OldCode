...
legend([p1 p2 p3],'C = 2 uM, R = 120 nM', 'C = 2 uM, R = 120 nM', 'C = 2 uM, R = 250 nM', 'Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m2n4 plot mean squared error linear fit for k1', 'FontSize', 16);