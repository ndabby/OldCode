...
[estimated_k] = fminunc(@err_func_m0n6v1, k0);
...
[estimated_k] = fminunc(@err_func_m0n6v2, k0);
...
[estimated_k] = fminunc(@err_func_m0n6v3, k0);
...
legend([p1 p2 p3 p3c],'C = 1 uM, R = 120 nM', 'C = 1 uM, R = 120 nM', 'C = 1 uM, R = 250 nM', 'average fit', 'Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m0n6 plot mean squared error fit for k1', 'FontSize', 16);