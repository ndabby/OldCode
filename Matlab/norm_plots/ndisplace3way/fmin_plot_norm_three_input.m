...
options = odeset('MaxStep',100,'refine',1e-18,'InitialStep',100,'RelTol',1e-18,'AbsTol',1e-18);
...
title('ndisplace clean toehold plot mean squared error fit for k1', 'FontSize', 16);