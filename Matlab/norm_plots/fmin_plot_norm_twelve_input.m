...
hold
[T,Y] = ode45(@fmin_toehold_norm_1,[0 86400],[start_conc1*max1b/max1, 0, 0, exp(estimated_k)],options);
plot(T,Y(:,3), ':r', 'LineWidth',2);

average = exp(estimated_k)
