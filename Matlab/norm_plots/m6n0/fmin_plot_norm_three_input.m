...
k0 = log(50); %in this case we are using k2 as fixed and k1 as adjustable parameter

[estimated_k] = fminunc(@err_func_m6n0v1, k0);
...
[estimated_k] = fminunc(@err_func_m6n0v2, k0);
...
[estimated_k] = fminunc(@err_func_m6n0v3, k0);
...
legend([p1 p2 p3 p1c],'C = 1.5 uM, R = 50 nM', 'C = 1.5 uM, R = 50 nM', 'C = 1.5 uM, R = 100 nM', 'Mean fit','Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m6n0 plot mean squared error fit for k1', 'FontSize', 16);