function dy = toehold_norm_9(t,y)

dy = zeros(3,1);
k2 = 0.001; %calculated from m16 data ALWAYS THE SAME

k1 = 15000; %calculated using Keff
concentration_difference = 4.5*10^-9; %difference in concentration between reactants

%here y(1) denotes reporter
%y(2) denotes joint complex
