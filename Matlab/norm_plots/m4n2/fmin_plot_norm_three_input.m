...
k0 = log(50); %in this case (long toehold) we are using k1 as fixed and k2 as adjustable parameter

[estimated_k] = fminunc(@err_func_m4n2v1, k0);
...
[estimated_k] = fminunc(@err_func_m4n2v2, k0);
...
[estimated_k] = fminunc(@err_func_m4n2v3, k0);
...
title('m4n2 plot mean squared error fit for k1', 'FontSize', 16);