...
[estimated_k] = fminunc(@err_func_m16n6v1, k0);
...
[estimated_k] = fminunc(@err_func_m16n6v2, k0);
...
[estimated_k] = fminunc(@err_func_m16n6v3, k0);
...
[estimated_k] = fminunc(@err_func_m16n6v4, k0);
...
[estimated_k] = fminunc(@err_func_m16n6v5, k0);
...
title('m16n6 mean squared error fit for k2', 'FontSize', 16);
