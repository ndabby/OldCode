...
[estimated_k] = fminunc(@err_func_m0n2v1, k0);
...
[estimated_k] = fminunc(@err_func_m0n2v2, k0);
...
[estimated_k] = fminunc(@err_func_m0n2v3, k0);
...
title('m0n2 plot mean squared error fit for k1', 'FontSize', 16);