function dy = toehold_norm_1(t,y)

dy = zeros(4,1);

k2 = 0.0004; %calculated from m16 data ALWAYS THE SAME

%k1 = y(4); 
concentration_difference = 0.15*10^(-6); %difference in concentration between reactants
