function dy = fmin_toehold_norm_2(t,y)

dy = zeros(4,1);

k2 = 0.00048662; %calculated from m16 data ALWAYS THE SAME

k1 = y(4); 
concentration_difference = 2.88*10^-6; %difference in concentration between reactants

dy(1) = -y(4)*(concentration_difference + y(1))*y(1); 
dy(2) = y(4)*y(1)*(concentration_difference+y(1))-k2*y(2);
dy(3) = k2*y(2);
