...
k0 = log(1); %in this case (long toehold) we are using k1 as fixed and k2 as adjustable parameter

[estimated_k] = fminunc(@err_func_m2n6v1, k0);
...
[estimated_k] = fminunc(@err_func_m2n6v2, k0);
...
[estimated_k] = fminunc(@err_func_m2n6v3, k0);
...
legend([p1 p2 p3 p3c],'C = 200 nM, R = 50 nM', 'C = 200 nM, R = 50 nM', 'C = 200 nM, R = 25 nM', 'average fit', 'Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m2n6 plot mean squared error fit for k1', 'FontSize', 16);