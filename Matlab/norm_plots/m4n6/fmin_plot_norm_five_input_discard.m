...
legend([ p3 p4 p5 p5c],'C = 1 nM, R = 0.5 nM', 'C = 2.5 nM, R = 0.5 nM', 'C = 2.5 nM, R = 0.5 nM', 'average fit','Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m4n6 mean squared error fit minus two traces', 'FontSize', 16);
