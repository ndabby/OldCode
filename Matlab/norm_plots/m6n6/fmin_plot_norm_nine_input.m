...
[estimated_k] = fminunc(@err_func_m6n6v2, k0);
...
[estimated_k] = fminunc(@err_func_m6n6v3, k0);
...
[estimated_k] = fminunc(@err_func_m6n6v4, k0);
...
[estimated_k] = fminunc(@err_func_m6n6v5, k0);
...
[estimated_k] = fminunc(@err_func_m6n6v6, k0);
...
[estimated_k] = fminunc(@err_func_m6n6v7, k0);
...
[estimated_k] = fminunc(@err_func_m6n6v8, k0);
...
%[estimated_k] = fminunc(@err_func_m6n6v9, k0);

%options = odeset('MaxStep',100,'refine',1e-10,'InitialStep',100,'RelTol',1e-10,'AbsTol',1e-10);

%testplotmn9 = (m_n9 - baseline9)/(max9-baseline9)*startconc9
...
legend([p2 p3 p4 p5 p6 p7 p8 p8c],'C = 2.5 nM, R = 2.5 nM', 'C = 1 nM, R = 0.5 nM', 'C = 2.5 nM, R = 0.5 nM', 'C = 2.5 nM, R = 0.5 nM','C = 2.5 nM, R = 2.5 nM', 'C = 2.5 nM, R = 2.5 nM', 'C = 2.5 nM, R = 2.5 nM', 'average fit', 'Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m6n6 mean squared error fit', 'FontSize', 16);
