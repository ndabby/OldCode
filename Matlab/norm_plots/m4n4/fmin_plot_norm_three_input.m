...
k0 = log(460); %in this case we are using k2 as fixed and k1 as adjustable parameter

[estimated_k] = fminunc(@err_func_m4n4v1, k0);
...
[estimated_k] = fminunc(@err_func_m4n4v2, k0);
...
[estimated_k] = fminunc(@err_func_m4n4v3, k0);
...
legend([p1 p2 p3 p1c],'C = 200 nM, R = 50 nM', 'C = 200 nM, R = 50 nM', 'C = 200 nM, R = 25 nM', 'Mean fit','Location','Best')
set(gca,'FontSize',14);
xlabel('Time (in hours)','FontSize',16);
ylabel('Normalized Fluorescence (nM)', 'FontSize', 16);
title('m4n4 plot mean squared error fit for k1', 'FontSize', 16);