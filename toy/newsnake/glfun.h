...
#include <GLUT/glut.h>
#include <stdlib.h>
#include <math.h>	//acos function among other things
...
void rotate(nubot*); //this function controls space exploration
std::vector<nubot*> DFSvisit(std::vector<nubot*>, nubot*);		//recursively called by DFS
void clearDFS(nubot**, int);	//clears discover bits after rotation